...
* #### 3.3 Git & DevOps
    ...
    * For the DevOps part, we created a CICD part where we etablished the test before each pull on a dev branch or on a merge on the master branch with Github action
